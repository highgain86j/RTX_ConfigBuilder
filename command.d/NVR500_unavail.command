...
isdn arrive global permit ${interface permit} 
...
no dhcp scope ${scope_num} [${ip_address-ip_address} 
...
no sip server arrive number display 
...
remote setup ${interface} [${isdn_num} [/ ${sub_address}] ] 
...
show nat descriptor address [${nat_descriptor}] 
